...
/**
 * Created by Ramanprit Kaur on 10/7/2015.
 */

/*
 * Source:
 * Below link is for an answer on StackOverflow that showed how to create a rectangle that can be dragged
 * http://stackoverflow.com/questions/18765445/select-a-portion-of-image-in-imageview-and-retrieve-the-end-points-of-selected-r
 */
public class DragRectView extends View {
    ...
    public DragRectView(final Context context) {
        super(context);
        Log.d("#################", " DragRectView(Context context)");
        init();
    }

    public DragRectView(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        Log.d("#################", " DragRectView(Context context, AttributeSet attrs)");
        init();
    }
    ...
    public DragRectView(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        init();
        Log.d("#################", " DragRectView(Context context, AttributeSet attrs, int defStyle)");
    }
     ...
     */
    private void init() {
        Log.d("#################", " DragRectView init()");
        mRectPaint = new Paint();
        mRectPaint.setColor(getContext().getResources().getColor(android.R.color.holo_green_light));
        //mRectPaint.setColor(getContext().getResources().getColor(R.color.dark_green, null));

        Log.d("#################", " DragRectView setStyle");
        ...
        //mTextPaint.setColor(getContext().getResources().getColor(android.R.color.holo_green_light, null));
